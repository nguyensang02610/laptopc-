...
namespace QL_BanHangThuanAn
{
    public partial class frmMain : Form
    {
        ...
        private void frmMain_Load(object sender, EventArgs e)
        {
            ...
            {
                this.lbnhacungcap.Enabled = false;
                this.lbhanghoa.Enabled = false;
                this.lbnhanvien.Enabled = false;
                this.lbbaocao.Enabled = false;
                
            }
            else if (SqlHelper.loainguoidung == 3)
            {
                this.lbhoadon.Enabled = false;
            }
        ...
        private void thôngKêBiểuĐồToolStripMenuItem_Click(object sender, EventArgs e)
        {
