...
namespace QL_BanHangThuanAn
{
    public partial class frmDMHangHoa : Form
    {
        ...
        private void DataGridView_Click(object sender, EventArgs e)
        {
            ...
            txtDongianhap.Text = string.Format(new CultureInfo("vi-VN"), "{0:#,##0}", DataGridView.CurrentRow.Cells["Dongianhap"].Value);
            txtDongiaban.Text = string.Format(new CultureInfo("vi-VN"), "{0:#,##0}", DataGridView.CurrentRow.Cells["Dongiaban"].Value);
